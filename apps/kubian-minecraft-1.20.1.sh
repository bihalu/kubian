...
################################################################################
# mincraft 1.20.1 -> https://artifacthub.io/packages/helm/minecraft-server-charts/minecraft/4.10.0
...
https://itzg.github.io/minecraft-server-charts itzg minecraft 4.10.0
EOL_HELM_CHARTS
...
if [ \$INSTALL = true ] ; then
  ...
  helm upgrade --install minecraft helm/minecraft-4.10.0.tgz \
    --create-namespace \
    --namespace minecraft \
    --version 4.10.0 \
